...
void render3DModel(Graphics* graphics, MATRIX* cameraMatrix, const T& model, TIM_IMAGE* texture, bool test = false)
{
    ...
    {
        const CVECTOR colors[4] = {model.colors[quadIndex.color1],model.colors[quadIndex.color0], model.colors[quadIndex.color2], model.colors[quadIndex.color3]};
        const DVECTOR uvs[4] = {model.uvs[quadIndex.uv1], model.uvs[quadIndex.uv0], model.uvs[quadIndex.uv2], model.uvs[quadIndex.uv3]};
        ...
        gte_ldir0(2048);
        const SVECTOR v4 = midpoint(model.vertices[quadIndex.vertice1], model.vertices[quadIndex.vertice0]);
        const SVECTOR v5 = midpoint(model.vertices[quadIndex.vertice1], model.vertices[quadIndex.vertice2]);
        const SVECTOR v6 = midpoint(model.vertices[quadIndex.vertice0], model.vertices[quadIndex.vertice3]);
        const SVECTOR v7 = midpoint(model.vertices[quadIndex.vertice2], model.vertices[quadIndex.vertice3]);
        const SVECTOR v8 = midpoint(v5, v6);

        //model.uvs[quadIndex.uv1], model.uvs[quadIndex.uv0], model.uvs[quadIndex.uv2], model.uvs[quadIndex.uv3]

        const DVECTOR uv4 = midpoint_uv(model.uvs[quadIndex.uv1], model.uvs[quadIndex.uv0]);
        const DVECTOR uv5 = midpoint_uv(model.uvs[quadIndex.uv1], model.uvs[quadIndex.uv2]);
        const DVECTOR uv6 = midpoint_uv(model.uvs[quadIndex.uv0], model.uvs[quadIndex.uv3]);
        const DVECTOR uv7 = midpoint_uv(model.uvs[quadIndex.uv2], model.uvs[quadIndex.uv3]);
        const DVECTOR uv8 = midpoint_uv(uv5, uv6);

        const CVECTOR color4 = midpoint_color(model.colors[quadIndex.color1], model.colors[quadIndex.color0]);
        const CVECTOR color5 = midpoint_color(model.colors[quadIndex.color1], model.colors[quadIndex.color2]);
        const CVECTOR color6 = midpoint_color(model.colors[quadIndex.color0], model.colors[quadIndex.color3]);
        const CVECTOR color7 = midpoint_color(model.colors[quadIndex.color2], model.colors[quadIndex.color3]);
        ...
        gte_ldv3(&model.vertices[quadIndex.vertice3], &v6, &v7);
        gte_rtpt();
        ...
        setPolyGT4(quad_0458);
        setPolyGT4(quad_4186);
        setPolyGT4(quad_5827);
        setPolyGT4(quad_8673);
        ...
        quad_0458->tpage = tpage;
        quad_4186->tpage = tpage;
        quad_5827->tpage = tpage;
        quad_8673->tpage = tpage;

        quad_0458->u0 = uvs[0].vx;
        quad_0458->v0 = uvs[0].vy;
        quad_0458->u1 = uv4.vx;
        quad_0458->v1 = uv4.vy;
        quad_0458->u2 = uv5.vx;
        quad_0458->v2 = uv5.vy;
        ...
        quad_4186->u0 = uv4.vx;
        quad_4186->v0 = uv4.vy;
        quad_4186->u1 = uvs[1].vx;
        quad_4186->v1 = uvs[1].vy;
        quad_4186->u2 = uv8.vx;
        quad_4186->v2 = uv8.vy;
        quad_4186->u3 = uv6.vx;
        quad_4186->v3 = uv6.vy;
        ...
        quad_5827->u1 = uv8.vx;
        quad_5827->v1 = uv8.vy;
        quad_5827->u2 = uvs[2].vx;
        quad_5827->v2 = uvs[2].vy;
        quad_5827->u3 = uv7.vx;
        quad_5827->v3 = uv7.vy;
        ...
        quad_8673->u2 = uv7.vx;
        quad_8673->v2 = uv7.vy;
        quad_8673->u3 = uvs[3].vx;
        quad_8673->v3 = uvs[3].vy;
