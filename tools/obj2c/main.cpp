...
void print_usage()
{
    ...
    std::cout<<"-type <value>   - Specifies the type of the model. Can be one of {obj, mdl}"<<'\n';
...
int main(int argc, char** argv)
{
    ...
    //const fs::path path = "dog.mdl";
    //const std::string output = "dog.ps1";

    //obj2c converter(path, output, 100, 64, 64, 4096, "mdl");
    //converter.generate();
