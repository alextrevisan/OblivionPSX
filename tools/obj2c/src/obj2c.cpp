...
obj2c::obj2c(const fs::path& path, const fs::path& output, const int verticeScale, const int textureSizeU, const int textureSizeV, const int normalScale, const std::string& type)
...
void obj2c::processMDL(const fs::path& path)
{
    // const fs::path& output, const int verticeScale, const int textureSizeU, const int textureSizeV, const int normalScale
    MDLLoader loader(path, OutputFile, VerticeScale, TextureSizeU, TextureSizeV, NormalScale);
}
